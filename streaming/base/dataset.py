...
class StreamingDataset(Array, IterableDataset):
    ...
    * How to iterate:
    ...
    def __init__(self,
        ...
        self._next_epoch = -1 if self.global_shm_path is None else GlobalSharedScalar(np.int64, os.path.join(self.global_shm_path, _get_path(self._shm_prefix_int, NEXT_EPOCH)))
    ...
    def next_epoch(self) -> int:
        ...
        Returns:
            int: Next epoch.
        """
        return self._next_epoch if isinstance(self._next_epoch, int) else int(self._next_epoch.get())
    ...
    def next_epoch(self, next_epoch: int) -> None:
        ...
        """
        if isinstance(self._next_epoch, int):
